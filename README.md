# SafeMind
:root {
    --color-primary: #2E6F54;      /* Forest Green */
    --color-primary-light: #B7E4C7;/* Mint Green */
    --color-bg: #FAFAF7;           /* Soft Off-White */
    --color-surface: #F4EDE4;      /* Warm Beige */
    --color-muted: #CBD5C0;        /* Sage Gray */
